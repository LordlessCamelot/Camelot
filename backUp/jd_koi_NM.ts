...
let min: number[] = [0.02, 0.12, 0.3, 0.6, 0.7, 0.8, 1, 2], log: string = '', logIndex: number = 10,logs: string = '',rom: string = '',
!(async () => {
...
let {data} = await axios.get(`https://api.jdsharecode.xyz/api/jlhb`, {
    headers: {
