...
[task_local]
#东东工厂
50 4,17 * * * jd_jdfactory_help_help.js, tag=东东工厂, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_factory.png, enabled=true

================Loon==============
[Script]
cron "50 4,17 * * *" script-path=jd_jdfactory_help.js,tag=东东工厂

===============Surge=================
东东工厂 = type=cron,cronexp="50 4,17 * * *",wake-system=1,timeout=3600,script-path=jd_jdfactory_help.js

============小火箭=========
东东工厂 = type=cron,script-path=jd_jdfactory_help.js, cronexpr="50 4,17 * * *", timeout=3600, enable=true
 */
