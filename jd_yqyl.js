...
[task_local]
#邀请有礼
45 0 * * * jd_yqyl.js, tag=邀请有礼, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
=================================Loon===================================
[Script]
cron "45 0 * * *" script-path=jd_yqyl.js,tag=邀请有礼
===================================Surge================================
邀请有礼 = type=cron,cronexp="45 0 * * *",wake-system=1,timeout=3600,script-path=jd_yqyl.js
====================================小火箭=============================
邀请有礼 = type=cron,script-path=jd_yqyl.js, cronexpr="45 0 * * *", timeout=3600, enable=true
 */
const $ = new Env('邀请有礼');
