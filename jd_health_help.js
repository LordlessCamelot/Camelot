...
[task_local]
#东东健康社区
5 4,14 * * * jd_health_help.js, tag=东东健康社区, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "5 4,14 * * *" script-path=jd_health_help.js, tag=东东健康社区

====================Surge================
东东健康社区 = type=cron,cronexp="5 4,14 * * *",wake-system=1,timeout=3600,script-path=jd_health_help.js

============小火箭=========
东东健康社区 = type=cron,script-path=jd_health_help.js, cronexpr="5 4,14 * * *", timeout=3600, enable=true
 */
